...
void loop() {
  ...
  voltage2 = readComparisonChannel(ADS1115_COMP_0_3);
  ...
  // Serial.print("0 and 3: ");
  // voltage = readComparisonChannel(ADS1115_COMP_0_3);
  // Serial.println(voltage);


  // Serial.print("Channel 1: ");
  // voltage = readChannel(1);
  // Serial.println(voltage);

  // Serial.print(" Channel 3: ");
  // voltage = readChannel(3);
  // Serial.println(voltage);
...
float readChannel(size_t channel) {
  float v = 0.0;
  adc.setSingleChannel(channel);
  v = adc.getResult_V(); // alternative: getResult_mV for Millivolt
  return v;
}
